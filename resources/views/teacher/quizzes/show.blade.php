...
<section class="container" style="padding-bottom: 6rem;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 2rem; align-items: start;">
        ...
        <div>
            ...
            <div class="glass-panel" style="padding: 1.5rem; margin-bottom: 1rem; border-left: 3px solid var(--primary);">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 1rem;">
                    ...
                    <form action="{{ route('teacher.questions.destroy', $question) }}" method="POST" onsubmit="return confirm('Delete this question?')" style="flex-shrink: 0;">
                        @csrf @method('DELETE')
        ...
        <div class="glass-panel" style="padding: 2rem; position: sticky; top: 90px;">
            ...
            <form action="{{ route('teacher.quizzes.questions.store', $quiz) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <p style="color: var(--text-muted); font-size: 0.8; margin-bottom: 1rem;">
