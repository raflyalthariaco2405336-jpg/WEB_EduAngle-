...
<section class="page-header" style="padding-bottom: 1rem;">
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
            <div>
                <h1><i class="fa-solid fa-list-check" style="color: var(--secondary);"></i> Quiz Management</h1>
                <p style="color: var(--text-muted);">Create and manage interactive quizzes for your students.</p>
            </div>
    ...
    <div class="glass-panel" style="overflow: hidden;">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="{{ route('teacher.quizzes.show', $quiz) }}" class="btn btn-outline btn-sm" style="padding: 0.4rem 0.9rem; font-size: 0.85rem;">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <a href="{{ route('teacher.quizzes.edit', $quiz) }}" class="btn btn-outline btn-sm" style="padding: 0.4rem 0.9rem; font-size: 0.85rem;">
                                <i class="fa-solid fa-pen"></i>
                            </a>
                            <form action="{{ route('teacher.quizzes.destroy', $quiz) }}" method="POST" onsubmit="return confirm('Delete this quiz and all its questions?')">
                                @csrf @method('DELETE')
                ...
                @empty
                <tr><td colspan="5" style="text-align: center; color: var(--text-muted); padding: 3rem;">No quizzes yet. <a href="{{ route('teacher.quizzes.create') }}" style="color: var(--secondary);">Create one</a>.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
