...
<section class="container" style="padding-bottom: 6rem; max-width: 700px;">
    <div class="glass-panel" style="padding: 2.5rem;">
        <form action="{{ route('dashboard.quizzes.update', $quiz) }}" method="POST">
            @csrf @method('PUT')
            ...
            <div style="display: flex; gap: 1rem;">
                ...
                <a href="{{ route('dashboard.quizzes.show', $quiz) }}" class="btn btn-outline" style="padding: 0.75rem 1.5rem;">
                    Manage Questions
                </a>
            </div>
        </form>
